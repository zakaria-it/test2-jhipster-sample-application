...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'payment' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('web-enabled systems synergize').should('have.value', 'web-enabled systems synergize');
