...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-06-16T08:20').blur().should('have.value', '2023-06-16T08:20');

      cy.get(`[data-cy="endDate"]`).type('2023-06-15T15:17').blur().should('have.value', '2023-06-15T15:17');
