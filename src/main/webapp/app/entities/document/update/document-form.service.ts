...
type DocumentFormGroupContent = {
  ...
  image: FormControl<IDocument['image']>;
  imageContentType: FormControl<IDocument['imageContentType']>;
  country: FormControl<IDocument['country']>;
};
...
export class DocumentFormService {
  createDocumentFormGroup(document: DocumentFormGroupInput = { id: null }): DocumentFormGroup {
    ...
    return new FormGroup<DocumentFormGroupContent>({
      ...
      image: new FormControl(documentRawValue.image),
      imageContentType: new FormControl(documentRawValue.imageContentType),
      country: new FormControl(documentRawValue.country),
    });
  }
