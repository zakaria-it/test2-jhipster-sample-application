...
type LocationFormGroupContent = {
  ...
  file: FormControl<ILocation['file']>;
  fileContentType: FormControl<ILocation['fileContentType']>;
...
export class LocationFormService {
  createLocationFormGroup(location: LocationFormGroupInput = { id: null }): LocationFormGroup {
    ...
    return new FormGroup<LocationFormGroupContent>({
      ...
      file: new FormControl(locationRawValue.file),
      fileContentType: new FormControl(locationRawValue.fileContentType),
